...
echo ""
echo "Note: System dependencies (v4l-utils, ffmpeg, v4l2loopback-dkms, python3-pyqt5) were not removed"
echo "      as they may be used by other applications."
echo ""
echo "To completely remove system dependencies:"
echo "  sudo apt remove v4l-utils v4l2loopback-dkms ffmpeg python3-pyqt5"
